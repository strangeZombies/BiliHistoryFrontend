    ...
    <div class="fixed left-0 right-0 top-0 z-50 bg-white px-1.5">
      <div class="relative mx-auto max-w-4xl p-1">
        ...
        <input
          ...
          class="w-full rounded-lg border border-gray-300 bg-[#edf2fa] p-2 text-gray-900 hover:bg-[#e1e6ed] focus:outline-none focus:ring-1 focus:ring-[#00A1D6] lm:text-xs lg:text-lg"
        />
      </div>
